document.addEventListener('DOMContentLoaded', () => {
    ...
    const fetchGallery = () => {
        ...
        const galleryItems = [
            ...
            { id: 6,  title: "Kunjungan UMKM Produksi Madu Lebah #2",   description: "Dokumentasi lanjutan kunjungan ke tempat budidaya lebah Trigona (lebah klanceng) Dusun Wungurejo.",                                    image_url: "assets/GaleriUMKM/Kunjuangan_UMKM_Produksi_Madu_Lebah_6_Juli_2026#3.JPG",        date: "2026-07-06" },
